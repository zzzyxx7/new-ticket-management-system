...
CREATE TABLE `code` (
                        ...
                        `used` int DEFAULT '0',
                        PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='验证码';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='订单表（适配支付宝沙盒支付，session_id为整数）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sessions` VALUES (1,1,'2025-01-01 19:30:00','02:30:00',22.00,23,555),(2,2,'2025-01-05 20:00:00','01:45:00',10.00,71,122),(3,3,'2025-01-10 19:00:00','03:00:00',3.44,1,131),(4,4,'2025-05-01 13:00:00','08:00:00',1100101.00,2,1234),(5,1,'2025-01-02 19:30:00','02:30:00',0.00,2,123),(6,1,'2026-02-14 16:56:29','16:56:31',50.00,5,255),(7,3,'2026-02-14 16:57:32','16:57:37',666.00,0,2);
...
CREATE TABLE `user_address` (
                                ...
                                `detailed_address` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '具体详细地址（不含省市区）',
                                `full_address` varchar(600) COLLATE utf8mb4_unicode_ci GENERATED ALWAYS AS (concat(`province`,`city`,`district`,`detailed_address`)) STORED COMMENT '完整地址（省市区+具体地址）',
                                `is_default` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否默认地址 0-否 1-是',
                                `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                                PRIMARY KEY (`id`),
                                KEY `idx_user_id` (`user_id`) COMMENT '用户ID索引，优化查询',
                                KEY `idx_create_time` (`create_time`) COMMENT '创建时间索引'
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户地址表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-02-14 17:03:15
